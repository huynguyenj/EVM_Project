/*
  ...
  - The values [PAID] on the enum `AgencyOrderStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."AgencyOrderStatus_new" AS ENUM ('DRAFT', 'ACCEPTED', 'PENDING', 'APPROVED', 'DELIVERED', 'CANCELED');
